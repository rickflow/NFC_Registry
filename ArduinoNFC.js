...
class ArduinoNFC{
    constructor(){
	let portName = isNaN(parseInt(config.SERIALPORT))? config.SERIALPORT : `COM${config.SERIALPORT}`
	this.port = new SerialPort(portName, { autoOpen: false, baudRate: config.baudRate })
	this._currentOutput = ''
